...
import demo from '@/assests/suggestion/suggestion1.jpeg'
...
export default function HeroVideo({
  ...
  return (
    (<div className={cn("relative", className)}>
      <div
        className=" flex flex-1 justify-center cursor-pointer group"
        ...
        <Image
          ...
          width={1920}
          height={1080}
          className="w-[50%] transition-all duration-200 group-hover:brightness-[0.8] ease-out rounded-md shadow-lg border" />
        <div
